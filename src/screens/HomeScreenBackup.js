...
import { Text, StyleSheet, View, Image, ImageBackground, TouchableOpacity, Dimensions, PermissionsAndroid, ActivityIndicator } from 'react-native';
  ...
  connectToDevice = dvc => {
    dvc
      ...
      .then(device => {
        ...
        setState({...state, devices: [], devicesMeta: null, isScanning: false, listBleDevices: false});
              ...
              state.devicesMeta.map((device, idx) => (
                <View key={idx} style={styles.row}>
                  ...
                  <BLEButton
                    title="Connect"
                    onPress={() =>
                      connectToDevice(state.devices[idx].device)
                    }
                  />
                </View>
              ))}
      ...
      {!state.listBleDevices && (
        ...
        <View style={styles.switchViewStyle}>
          <TouchableOpacity onPress={_onPressButton} >
            <Image
              source={state.listBleDevices ? require('../assets/img/switch.png'): require('../assets/img/switch-off.png')}
            />
          </TouchableOpacity>
        </View>
